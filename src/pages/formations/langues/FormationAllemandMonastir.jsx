...
export default function FormationAllemandMonastir() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const found = searchInFormations(data, "allemand");
  ...
  const title = formationData?.title || "Formation Allemand à Monastir";
  const description = formationData?.description || "Formation Allemand certifiante à Monastir. Cours A1 à B1, préparation Goethe/ÖSD.";
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 mt-20">
        ...
        >
          ...
          <ul className="space-y-2 text-gray-600 mb-6">
            <li>✅ Maîtrise des bases de la grammaire allemande</li>
            <li>✅ Expression orale et écrite</li>
            <li>✅ Compréhension et production de textes</li>
            <li>✅ Préparation aux examens Goethe-Zertifikat et ÖSD</li>
