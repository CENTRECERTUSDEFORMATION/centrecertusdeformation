// frontend/src/pages/formations/langues/FormationEspagnolMonastir.jsx
...
export default function FormationEspagnolMonastir() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const found = searchInFormations(data, "espagnol");
  ...
  const title = formationData?.title || "Formation Espagnol à Monastir";
  const description = formationData?.description || "Formation Espagnol certifiante à Monastir. Cours A1 à B1, préparation DELE.";
  const duration = formationData?.duration || "60h à 100h";
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://centrecertusdeformation.tn/formation-espagnol-monastir" />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta property="og:url" content="https://centrecertusdeformation.tn/formation-espagnol-monastir" />
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-purple-50 p-4 rounded-xl text-center">
              ...
              <p className="text-xl font-bold text-purple-700">DELE</p>
            </div>
          </div>
          ...
          <ul className="space-y-2 text-gray-600 mb-6">
            <li>✅ Maîtrise de l'espagnol conversationnel</li>
            <li>✅ Grammaire et conjugaison espagnole</li>
            <li>✅ Culture hispanophone</li>
            <li>✅ Préparation aux examens DELE</li>
            <li>✅ Cours adaptés aux débutants et niveaux avancés</li>
          </ul>
