// frontend/src/pages/formations/langues/FormationFrancaisMonastir.jsx
...
export default function FormationFrancaisMonastir() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // ✅ Peu importe "francais" ou "français", la normalisation fonctionne
        const found = searchInFormations(data, "francais");
  ...
  const title = formationData?.title || "Formation Français à Monastir";
  const description = formationData?.description || "Formation Français certifiante à Monastir. Cours A1 à B2, préparation DELF/DALF.";
  const duration = formationData?.duration || "60h à 120h";
  const price = formationData?.price || "450 DT";
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://centrecertusdeformation.tn/formation-francais-monastir" />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta property="og:url" content="https://centrecertusdeformation.tn/formation-francais-monastir" />
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-50 p-4 rounded-xl text-center">
              ...
              <p className="text-xl font-bold text-blue-700">A1 à B2</p>
            </div>
            ...
            <div className="bg-purple-50 p-4 rounded-xl text-center">
              ...
              <p className="text-xl font-bold text-purple-700">DELF • DALF</p>
            </div>
          </div>
          ...
          <ul className="space-y-2 text-gray-600 mb-6">
            <li>✅ Maîtrise du français professionnel et quotidien</li>
            <li>✅ Grammaire et conjugaison avancées</li>
            <li>✅ Expression écrite et orale</li>
            <li>✅ Préparation aux examens DELF et DALF</li>
            <li>✅ Cours de français général et français des affaires</li>
          </ul>
